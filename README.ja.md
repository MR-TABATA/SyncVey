...
| 機能 | 説明 |
|------|------|
| **資産台帳** | EC2 / ECS / Lambda / RDS / DynamoDB / ElastiCache / EFS / EKS / S3 / ALB / VPC / EBS / SNS / SQS / API Gateway / Secrets Manager / CloudFront / Route 53 ほかを一覧・検索 |
...
公開イメージ（[`mrtabata/syncvey`](https://hub.docker.com/r/mrtabata/syncvey)、amd64 / arm64）を取得して起動します。ビルドもコンパイルも走りません。
...
>
> **版を固定する場合:** `.env` に `SYNCVEY_IMAGE=mrtabata/syncvey:0.2.0` を設定します。
...
/blast-radius/                         影響波及範囲（参照グラフ上のドリフト影響・オプションのプラグイン）
